// FORCE RESPONSIVE MOBILE - Script ultra agressif
(function() {
    'use strict';
    ...
    // FORCE HIDE ALL IMAGES (home, formulaire, intro)
    function forceHideAllImages() {
        console.log("🔧 Forcing hide ALL images...");
        
        // Masquer TOUTES les .split-layout-gradient (home, formulaire, intro)
        ...
        console.log("✅ All images hidden! (" + images.length + " images)");
    }
    
    // FORCE GRIDS - 1 colonne sur mobile
    function forceGrids() {
        console.log("🔧 Forcing grids to 1 column...");
        
        // Toutes les grilles de choix
        const grids = document.querySelectorAll('.choice-grid, .choice-grid-2, .choice-grid-3, [class*="grid-"], [class*="choice-grid"]');
        ...
        // Toutes les cartes de choix - FORCER width 100%
        ...
        console.log("✅ Grids forced! (" + grids.length + " grids, " + cards.length + " cards)");
    }
